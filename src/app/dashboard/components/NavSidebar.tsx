...
import { BarChart3Icon, FlaskConicalIcon, MessageSquareIcon, SquarePenIcon, UploadIcon } from 'lucide-react';
...
const links = [
    ...
    { href: '/settings/prompts', icon: SquarePenIcon,     label: 'Prompts' },
];
